    ...
    describe "lowestCommonAncestor" $ do
      it "1" $ do
        ...
        lowestCommonAncestor
          ...
          (Set.fromList [StateId 1, StateId 2]) `shouldBe` Just (StateId 0)
      ...
      it "2" $ do
        ...
        lowestCommonAncestor
          ...
          (Set.fromList [StateId 2, StateId 3]) `shouldBe` Nothing
      ...
      it "3" $ do
        ...
        lowestCommonAncestor
          ...
          (Set.fromList [StateId 2, StateId 3]) `shouldBe` Just (StateId 4)
    ...
    describe "Versioned" $ do
      describe "set" $ do
        it "simple" $ do
          ...
          versionedHistory v1 `shouldBe`
            (Nil `Sequential` (Set 0, id0) `Sequential` (Set 5, id5from0))
        ...
        it "reset" $ do
          ...
          versionedHistory v1 `shouldBe`
            (Nil `Sequential`
              (Set 0, id0) `Sequential`
              (Set 5, id5from0) `Sequential`
              (Set 0, id0from5from0)
            )
      ...
      describe "merge" $ do
        ...
        it "conflict at creation" $ do
          ...
          versionedHistory v3 `shouldBe`
            (Nil `Concurrent`
              [ Nil `Sequential` (Set 10, id10)
        ...
        it "conflicting changes" $ do
          ...
          (pathsToRoot v3 =<< Map.keys (current v3)) `shouldBe`
            [ Seq.fromList [id10from0, id0]
            , Seq.fromList [id5from0, id0]
            ]

          versionedHistory v3 `shouldBe`
            (Nil `Sequential`
              (Set 0, id0) `Concurrent`
              [ Nil `Sequential` (Set 10, id10from0)
        ...
        it "resolved conflicting changes by replacement" $ do
          ...
          versionedHistory v4 `shouldBe`
            (Nil `Sequential`
              (Set 0, id0) `Concurrent`
                [ Nil `Sequential` (Set 10, id10from0)
                , Nil `Sequential` (Set 5, id5from0)
                ] `Sequential`
              (Set 15, id15from_id5from0andid10from0))
        ...
        it "resolved conflicting changes by picking" $ do
          ...
          versionedHistory v4 `shouldBe`
            (Nil `Sequential`
              ...
              (Pick id10from0, id10from_id5from0andid10from0)
            )
